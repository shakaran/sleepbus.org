...
define('EDIT_ACCOUNT_SERVICE_PROVIDER_SUBJECT',"Demo Website: admin details updated");

//service provider email address
define('SERVICE_PROVIDER_EMAIL_ADDRESS',"info@zeemo.com.au"); // change it to info@zeemo.com.au
define('CHANGE_SUPERADMIN_PASSWORD_SUBJECT',"Demo Website: superadmin new password");
...
// meta tags
define('DEFAULT_SUFFIX', " - Demo Site"); // or define('DEFAULT_SUFFIX', " - Gallay Medical & Scientific ");
define('ZEEMO_CONTACT_NO','1300 881 594');

// Determining base directory of the website for configuration of ckfinder to ckeditor
if(preg_match('/devs/',$_SERVER['HTTP_HOST'])) $_SESSION['base_dir'] = '/ci-application-new/'; // this value will be changed according as site directory name
else if(preg_match('/iisdemo.com.au/',$_SERVER['HTTP_HOST'])) $_SESSION['base_dir'] = '/projects/ci-application/'; // this value will be changed according as site directory name
