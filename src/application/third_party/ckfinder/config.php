<?php
include_once('./../../../../../helpers/settings_helper.php');
//session_start();
//include_once($_SERVER['DOCUMENT_ROOT'].'/ci-application-new/application/helpers/settings_helper.php');
//$script_filename=str_replace("index.php","",$_SERVER['SCRIPT_FILENAME']);
//include_once($script_filename.'application/helpers/settings_helper.php');
//echo "file_url=".$_SERVER['SCRIPT_FILENAME'].'application/helpers/settings_helper.php';
...
function CheckAuthentication()
{
    ...
    if(isset($_SESSION['base_dir']) and !empty($_SESSION['base_dir'])) return true;
	else return false;
}
...
*/
//$baseUrl = '/test/ckeditor/ckfinder/userfiles/';

//$baseUrl = '/ci-application-new/application/third_party/ckfinder/userfiles/';
$baseUrl = $_SESSION['base_dir'].'application/third_party/ckfinder/userfiles/';
//$baseUrl = BASE_DIR.'application/third_party/ckfinder/userfiles/';
/*
