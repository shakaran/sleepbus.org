...
<body>
 <?php
  echo form_open_multipart(base_url().admin.'/home/uploadBrochures', $attributes['form']);
...
<div style=" padding: 6px 5px 8px 5px !important;">
  ...
  <span class="main_heading" style="padding-top:3px;padding-bottom:5px;"><?php echo $page_title;?></span>
             ...
             <table width="98%" border="0" cellpadding="0" cellspacing="0" style="color: #636466;font-family: Arial;font-size: 11px;font-weight: bold;text-align: left;padding-left:22px;">
               ...
               <div id="drop">
               <div style="float:right;"><a href="<?php echo base_url().admin;?>/home/redirectToParentPage/<?php echo str_replace("/","~",$return_url);?>" title="Close"><img src="<?php echo base_url();?>images/<?php echo admin;?>/icons/tools/close-uploader.png" /></a></div>
				<div style="padding-left:170px;">Drop Here or

				<a class="browse">Browse</a>
				<input type="file" name="brochure_file" id="brochure_file" multiple />
