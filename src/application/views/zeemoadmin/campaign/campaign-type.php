           <div style="padding:25px;">
            ...
            <div id="input_text">
             ...
             <?php
              ...
              echo form_open_multipart(base_url().admin.'/campaign/validate-type',$attributes['form']);
              ...
              <table width="98%" border="0" cellpadding="0" cellspacing="0">
               ...
               <tr>
                ...
                <td style="padding-top:10px;padding-bottom:5px;">
                 ...
                 Mission Statement<span class="remarks">&nbsp;</span>

                 &nbsp;<span class="error1" id="error2"><?php echo form_error('mission_statement'); ?></span>
               ...
               <tr>
                ...
                <td colspan="4" align="left" valign="top">
                 ...
                 <?php echo form_textarea($attributes['mission_statement']);	  ?>
           ...
           <div class="record_list">
...

		     {
              ...
              echo form_open(base_url().admin.'/campaign/campaign-type',$attribute['form']);
			 ...
			 ?>
              ...
              <input type="hidden" name="file_path" value="<?php echo base_url().admin."/home/UpdatePosition/".CAMPAIGN_TYPE;?>" id="file_path" />
...

			  {
			   ...
			   ?>
			    ...
			    <li id="recordsArray_<?php echo $type['id'];?>" style="padding:2px;">
                 ...
                 <div class="ulTableinner_record sn-no-other-record" style="width:190px; text-align:center">
                  ...
                  <?php
...

				   {
				    ...
				    echo anchor(base_url().admin.'/campaign/changestatus/'.$type['id'].'/1/campaign-type', 'Show',array('title'=>'Show'))." | <span class='current_status'>Hide</span>";
...

				   {
				    ...
				    echo "<span class='current_status'>Show</span> | ".anchor(base_url().admin.'/campaign/changestatus/'.$type['id'].'/0/campaign-type', 'Hide',array('title'=>'Hide'));
                 ...
                 <a href="<?php echo base_url().admin;?>/campaign/edit-type/<?php echo $type['id'];?>" title="Edit">Edit</a>
                   ...
                   <?php
                    ...
                    &nbsp; |&nbsp;<a href="<?php echo base_url().admin;?>/campaign/ConfirmDelete/<?php echo $type['id'];?>/campaign_type&iframe=true&width=300&height=162" rel="prettyPhoto"  style="color: #884400;  text-decoration: none;" > <span class="tools_icon"> &nbsp;<?php  echo img(base_url()."images/".admin."/icons/tools/drop.png");?></span>&nbsp;Delete</a>
...

			 {
			  ...
			  ?>
			   ...
			   <div class="success"> No campaign types found.</div>
