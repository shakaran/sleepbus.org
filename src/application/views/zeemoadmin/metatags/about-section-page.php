			...
			if(count($all_pages) > 0)
			{
             ...
             <ul>
            	<li>
                	...
                	<div class="ulTableinner sn-no-other" style="width:340px;">Page Title</div>
			  ...
			  foreach($all_pages as $page)
			  {
			   ?>
			    <li id="recordsArray_<?php echo $page['id'];?>" <?php if($page['id'] == '0'){ $i=""; ?> style="background-color:white;"<?php }?>>
                 ...
                 <div class="ulTableinner_record sn-no-other-record" style="width:336px;padding:2px;"><?php echo $page['meta']['page_title'];?></div>
