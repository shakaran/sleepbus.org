         <?php
		  if(!empty($module_id))
		  {
           ...
           <div style="padding-right:590px;padding-top:20px;">
            <?php
            $js_function="OpenAddSubModule('".base_url().admin."/modules/add_submodule/".$module_id."')";
		    echo form_submit('add_new_submodule','Add New Submodule','onclick="'.$js_function.'"');			              
            ?>
           </div>
           <?php
		  }
            ...
            if(count($submodule_list) > 0)
		    {
             ...
             <ul>
            	<li>
                	...
                	<div class="ulTableinner sn-no-other" style="width:200px;">Status</div>
                	<div class="ulTableinner sn-no-other" style="width:160px;">Tools</div>
                    <div class="ulTableinner sn-no-other" style="width:50px;"><label>&nbsp;<?php if($module_url != "modules"){ ?> <span class="tools_icon"><?php echo form_checkbox($deletion_attributes['remove_all']);  ?>&nbsp;<?php echo img(base_url()."images/".admin."/icons/tools/check.png");?></span><?php }else{ echo "&nbsp";} ?></label></div>
                </li>
			   ...
			   ?>
			    <li id="recordsArray_<?php echo $module['id'];?>">
                 ...
                 <div class="ulTableinner_record sn-no-other-record" style="width:160px;">
                   ...
                   <?php
                    $js_update_function="OpenAddSubModule('".base_url().admin."/modules/edit_submodule/".$module['id']."')";
				   ...
				   ?>
                    ...
                    <!--&nbsp; |&nbsp;<a href="<?php echo base_url()?>admin/modules/helptext/<?php  echo $module['id'];?>/<?php  echo $module_id;?>?iframe=true&width=900&height=520" rel="prettyPhoto"><span class="tools_icon"><?php  echo img(base_url()."images/".admin."/icons/left/service.png");?></span>Help Text</a>-->
			  ...
			  ?>
               ...
               <ul>
            	<li>
                	...
                	<div class="ulTableinner_record sn-no-other" style="width:175px;">&nbsp;</div>
                    <div class="ulTableinner_record sn-no-other" style="width:77px;"><span class="tools_icon">
