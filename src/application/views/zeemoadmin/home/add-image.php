                            ...
                            <tr height="10">
                             <td align="left" valign="top" width="85%">
                              ...
                              <br /><span class="remarks"><?php if(isset($remarks)){ echo $remarks;}?></span>
                               ...
                               Alt/ Title text  :</div><div style="padding-top:6px;">  <?php echo form_input($attributes['image_alt_title_text']);?></div> 
                              ...
                              <td align="center" valign="top">
                               <?php
							    if(!empty($attributes['current_image']))
								{
                                 ...
                                 ?>
								 <img src="<?php echo $uploading_path;?>/<?php echo $attributes['current_image'];?>" width="200" height="100" />
                                 <br />
