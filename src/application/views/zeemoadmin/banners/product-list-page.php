           ...
           <?php
            ...
            <div class="clearfix"></div>
			  ...
			  foreach($all_banners as $banner)
			  {
			   ...
			   {
			    $upload_banner_for=ucfirst($banner['category_name'])." >> ".ucfirst($banner['page_name']);
				$delete_section="product_banners/".$category_id;
			   }
			   ?>
			    <li id="recordsArray_<?php echo $banner['page_id'];?>">
                 ...
                 <div class="ulTableinner_record sn-no-other-record" style="width:215px;">
                  <a href="javascript:void(0)" onclick="OpenBannerForm('<?php echo base_url()?>','<?php echo $banner['page_id']?>','<?php echo $page_type;?>','dynamic')" title="Edit" style="color: #884400;  text-decoration: none;"><span class="tools_icon"><?php echo img(base_url()."images/".admin."/icons/tools/edit.png");?></span>&nbsp;Edit</a>
                ...
                <?php 
				 if(!empty($banner['image_file']))
				 {
                  ?>  
				  <span class="gallery">
                    &nbsp; |&nbsp;<a href="<?php echo base_url().admin;?>/banners/ConfirmDelete/<?php echo $banner['banner_id'];?>/<?php echo $delete_section;?>&iframe=true&width=294&height=112" rel="prettyPhoto"  style="color: #884400;  text-decoration: none;" > <span class="tools_icon"> <?php echo img(base_url()."images/".admin."/icons/tools/delete.png");?></span>&nbsp;Delete</a>
                   </span>                  
                  <?php
				 }
                 ?>
			 ...
			 {
			  ?>
			   <div class="success" style="padding:15px;"> No product(s) found</div>
			  <?php
			 }
			?>  
