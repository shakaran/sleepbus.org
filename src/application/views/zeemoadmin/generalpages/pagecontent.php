			  ...
			  <?php
               if(!empty($page_id))
               {
                ?>
                 ...
                 <tr>
                  <td style="padding-top:10px;padding-bottom:5px;">
                   Content&nbsp;<span class="remarks" style="background-color:#FFA;color:#3F3F3F;padding:2px;">(Please don't change any text expressions written in the form [[abc]]. e.g [[BODY]] )</span>&nbsp;<span class="error1" id="error2"><?php echo form_error('content'); ?></span>
                  </td>
                 </tr>
                 <tr>
                  <td colspan="4" align="left">
