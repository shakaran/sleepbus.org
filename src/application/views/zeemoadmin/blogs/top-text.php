           <div style="padding:25px;">
            <div id="input_text">
             <?php
              echo form_open(base_url().admin.'/blogs/toptext',$attributes['form']);
			 ?>
                       ...
                       <div class="error1" id="error"><?php if(isset($error_msg)) echo $error_msg; ?></div>
                         ...
                         <tr>
                          <td style="padding-top:10px;padding-bottom:5px;">
                           Top Content&nbsp;<span class='remarks'>(To be displayed at the top of blog landing page)</span>&nbsp;<span class="error1" id="error1"><?php echo form_error('content'); ?></span>
               			  </td>
                         </tr>
                         <tr>
