<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="faqpage">
  <div class="row">
      <div id="faqheader">
            <H2>FREQUENTLY ASKED QUESTIONS</H2>
            <div id="custom-search-input" style="display:none;">
                <div class="input-group col-md-12">
                    <input type="text" class="form-control input-lg" placeholder="TYPE QUESTION HERE" />
          ...
          <h3 style="text-align: center;">Got a question? We’ve got you sorted.</h3>
          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 faq">
              <a href="#faq-service">
...
.scrollToTop{
    ...
    right:10px;
    display:none;
    background: url('<?php echo base_url();?>images/scroll_top_button.png') no-repeat 0px 20px;
