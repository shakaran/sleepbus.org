<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
 class Fundraise extends MY_Controller
 {
  ...
  public function index()
  {
   ...
   //  $values['campaign_end_date']=$this->input->post('campaign_end_date');
     ...
     //$this->form_validation->set_rules('campaign_end_date','Please enter campaign end date', 'trim|required|callback__ValidateEndDate');
...
*/
     ...
     { 
	  ...
	  $campaign_records['statement']=$values['statement'];
	  $campaign_records['campaign_image']=$values['campaign_image'];
/*	  $campaign_records['campaign_end_date']=$values['campaign_end_date'];
	  $campaign_records['campaign_type']=$values['campaign_type'];
	  $campaign_records['campaign_image']=$values['campaign_image'];
	  $campaign_records['url']=$values['url'];
*/	  
...
/*	 $values['campaign_end_date']=$this->data['campaign_details']['campaign_end_date'];
	 $values['campaign_image']=$this->data['campaign_details']['campaign_image'];
	 $values['mission_statement']=$this->data['campaign_details']['mission_statement'];
*/	}
